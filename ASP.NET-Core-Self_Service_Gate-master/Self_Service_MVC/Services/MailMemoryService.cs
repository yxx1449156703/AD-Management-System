...
{
    public class MailMemoryService : IMailService
    {
        ...
        public MailMemoryService(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
